...
function index({ title, description, tags, thumbnailUrl, ...props }) {
  return (
    <div className="p-[3rem] rounded-[1.6rem] border border-primary-bg-light flex flex-col items-center max-w-[36rem] hover:shadow-[0_0_10px_2px] hover:shadow-[rgba(51,48,51,1)]  transition-shadow">
