...
const DesignationCard = React.forwardRef(({ data, ...props }, ref) => {
  return (
    <div
      className="pb-[3rem] pt-[4.2rem] px-[2rem] border rounded-[1.6rem] border-primary-text flex justify-center flex-col items-center w-[24.6rem] translate-x-[-100%] cursor-pointer opacity-0 transition-all duration-500 hover:shadow-[0_0_10px_2px] hover:shadow-[rgba(51,48,51,1)]"
      ref={ref}
    >
